...
var G__19845 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__19845;
continue;
} else {
return ch;
...
var vec__19798 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19798,(0),null);
return (match === s);
});
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq19829){
...
return (function() { 
var G__19890__delegate = function (rdr,_){
...
var G__19890 = function (rdr,var_args){
var _ = null;
...
while (G__19891__i < G__19891__a.length) {G__19891__a[G__19891__i] = arguments[G__19891__i + 1]; ++G__19891__i;}
  _ = new cljs.core.IndexedSeq(G__19891__a,0,null);
} 
return G__19890__delegate.call(this,rdr,_);};
G__19890.cljs$lang$maxFixedArity = 1;
G__19890.cljs$lang$applyTo = (function (arglist__19892){
var rdr = cljs.core.first(arglist__19892);
var _ = cljs.core.rest(arglist__19892);
return G__19890__delegate(rdr,_);
});
