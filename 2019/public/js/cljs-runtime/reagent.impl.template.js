...
var G__29725 = o;
(G__29725[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__29853__delegate = function (args){
...
while (G__29854__i < G__29854__a.length) {G__29854__a[G__29854__i] = arguments[G__29854__i + 0]; ++G__29854__i;}
  args = new cljs.core.IndexedSeq(G__29854__a,0,null);
} 
return G__29853__delegate.call(this,args);};
...
return G__29853__delegate(args);
});
...
var G__29731 = o;
(G__29731[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__29745 = props;
var G__29745__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__29745,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__29745);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__29745__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__29747){
...
var props = map__29748__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29748__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__29748,map__29748__$1,props,class$){
return (function (c){
...
});})(map__29748,map__29748__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__29762){
var map__29763 = p__29762;
var map__29763__$1 = (((((!((map__29763 == null))))?(((((map__29763.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__29763.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__29763):map__29763);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29763__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__29763,map__29763__$1,on_write){
return (function (){
...
});})(node_value,map__29763,map__29763__$1,on_write))
);
} else {
...
var G__29778 = jsprops;
(G__29778["defaultValue"] = value);

(G__29778["onChange"] = ((function (G__29778,v,value,on_change){
return (function (p1__29777_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__29777_SHARP_);
});})(G__29778,v,value,on_change))
);
...
var vec__29786 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29786,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29786,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29786,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___29909 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___29909 == null)){
} else {
var key_29910 = temp__5724__auto___29909;
(jsprops["key"] = key_29910);
}
...
var temp__5724__auto___29911 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___29911 == null)){
} else {
var key_29912 = temp__5724__auto___29911;
reagent.impl.template.oset(jsprops,"key",key_29912);
}
...
var G__29803 = reagent.impl.template.__GT_NativeWrapper();
(G__29803["name"] = c);
...
var G__29809 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__29809) : reagent.impl.template.as_element.call(null,G__29809));
} else {
...
var len__4730__auto___29914 = arguments.length;
var i__4731__auto___29915 = (0);
while(true){
if((i__4731__auto___29915 < len__4730__auto___29914)){
args__4736__auto__.push((arguments[i__4731__auto___29915]));

var G__29916 = (i__4731__auto___29915 + (1));
i__4731__auto___29915 = G__29916;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq29813){
var G__29814 = cljs.core.first(seq29813);
var seq29813__$1 = cljs.core.next(seq29813);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29814,seq29813__$1);
});
...
break;
default:
var G__29918 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__29918;
continue;
...
var n__4607__auto___29924 = a.length;
var i_29925 = (0);
while(true){
if((i_29925 < n__4607__auto___29924)){
(a[i_29925] = reagent.impl.template.as_element((a[i_29925])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___29930 = a.length;
var i_29931 = (0);
while(true){
if((i_29931 < n__4607__auto___29930)){
var val_29932 = (a[i_29931]);
if(((cljs.core.vector_QMARK_(val_29932)) && ((reagent.impl.template.key_from_vec(val_29932) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_29931] = reagent.impl.template.as_element(val_29932));

var G__29941 = (i_29931 + (1));
i_29931 = G__29941;
continue;
} else {
}
...
var ctx = ({});
var vec__29820 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29820,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29820,(1),null);
...
var G__29831 = (cljs.core.count(argv) - first_child);
switch (G__29831) {
case (0):
...
case (1):
var G__29832 = comp;
var G__29833 = jsprops;
var G__29834 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__29832,G__29833,G__29834);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__29831){
