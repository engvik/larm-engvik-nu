...
var G__22001 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__22001;
continue;
} else {
return ch;
...
var vec__21982 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21982,(0),null);
return (match === s);
});
...
var len__4730__auto___22005 = arguments.length;
var i__4731__auto___22006 = (0);
while(true){
if((i__4731__auto___22006 < len__4730__auto___22005)){
args__4736__auto__.push((arguments[i__4731__auto___22006]));

var G__22007 = (i__4731__auto___22006 + (1));
i__4731__auto___22006 = G__22007;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq21999){
...
return (function() { 
var G__22018__delegate = function (rdr,_){
...
var G__22018 = function (rdr,var_args){
var _ = null;
...
while (G__22019__i < G__22019__a.length) {G__22019__a[G__22019__i] = arguments[G__22019__i + 1]; ++G__22019__i;}
  _ = new cljs.core.IndexedSeq(G__22019__a,0,null);
} 
return G__22018__delegate.call(this,rdr,_);};
G__22018.cljs$lang$maxFixedArity = 1;
G__22018.cljs$lang$applyTo = (function (arglist__22023){
var rdr = cljs.core.first(arglist__22023);
var _ = cljs.core.rest(arglist__22023);
return G__22018__delegate(rdr,_);
});
