...
var G__19677 = o;
(G__19677[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__19679 = o;
(G__19679[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__19726__i < G__19726__a.length) {G__19726__a[G__19726__i] = arguments[G__19726__i + 0]; ++G__19726__i;}
  args = new cljs.core.IndexedSeq(G__19726__a,0,null);
} 
...
var G__19684 = props;
var G__19684__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__19684,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__19684);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__19684__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__19685){
...
var props = map__19686__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19686__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__19686,map__19686__$1,props,class$){
return (function (c){
...
});})(map__19686,map__19686__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__19688){
var map__19689 = p__19688;
var map__19689__$1 = (((((!((map__19689 == null))))?(((((map__19689.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19689.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__19689):map__19689);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19689__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__19689,map__19689__$1,on_write){
return (function (){
...
});})(node_value,map__19689,map__19689__$1,on_write))
);
} else {
...
var G__19692 = jsprops;
(G__19692["defaultValue"] = value);

(G__19692["onChange"] = ((function (G__19692,v,value,on_change){
return (function (p1__19691_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__19691_SHARP_);
});})(G__19692,v,value,on_change))
);
...
var vec__19694 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19694,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19694,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19694,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___19776 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___19776 == null)){
} else {
var key_19777 = temp__5724__auto___19776;
(jsprops["key"] = key_19777);
}
...
var temp__5724__auto___19778 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___19778 == null)){
} else {
var key_19779 = temp__5724__auto___19778;
reagent.impl.template.oset(jsprops,"key",key_19779);
}
...
var G__19698 = reagent.impl.template.__GT_NativeWrapper();
(G__19698["name"] = c);
...
var G__19699 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__19699) : reagent.impl.template.as_element.call(null,G__19699));
} else {
...
var len__4730__auto___19781 = arguments.length;
var i__4731__auto___19782 = (0);
while(true){
if((i__4731__auto___19782 < len__4730__auto___19781)){
args__4736__auto__.push((arguments[i__4731__auto___19782]));

var G__19783 = (i__4731__auto___19782 + (1));
i__4731__auto___19782 = G__19783;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq19702){
var G__19703 = cljs.core.first(seq19702);
var seq19702__$1 = cljs.core.next(seq19702);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19703,seq19702__$1);
});
...
break;
default:
var G__19787 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__19787;
continue;
...
var n__4607__auto___19788 = a.length;
var i_19789 = (0);
while(true){
if((i_19789 < n__4607__auto___19788)){
(a[i_19789] = reagent.impl.template.as_element((a[i_19789])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___19791 = a.length;
var i_19792 = (0);
while(true){
if((i_19792 < n__4607__auto___19791)){
var val_19793 = (a[i_19792]);
if(((cljs.core.vector_QMARK_(val_19793)) && ((reagent.impl.template.key_from_vec(val_19793) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_19792] = reagent.impl.template.as_element(val_19793));

var G__19794 = (i_19792 + (1));
i_19792 = G__19794;
continue;
} else {
}
...
var ctx = ({});
var vec__19706 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19706,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19706,(1),null);
...
var G__19709 = (cljs.core.count(argv) - first_child);
switch (G__19709) {
case (0):
...
case (1):
var G__19710 = comp;
var G__19711 = jsprops;
var G__19712 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__19710,G__19711,G__19712);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__19709){
